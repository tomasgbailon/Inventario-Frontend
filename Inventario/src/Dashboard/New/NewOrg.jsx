...
export default function NewOrg(){
    ...
    useEffect(() => {
        if (clickedResult.name !== undefined && !selectedUsers.includes(clickedResult)) {
            setSelectedUsers([...selectedUsers, clickedResult]);
        }
    }, [clickedResult]);
    return(
        <SearchContext.Provider value={{searchTerm, setSearchTerm, searchResults, setSearchResults, clickedResult, setClickedResult}}>
