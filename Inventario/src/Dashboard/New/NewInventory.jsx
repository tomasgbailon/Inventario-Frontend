            ...
            <div className="new-org">
                ...
                <div className="new-org-content">
                    ...
                    <div className="new-org-form">
                        ...
                        <input type="text" className="new-org-input" id="orgName" placeholder="Nombre del inventario" />
                        <label className="orgName">Prefijo</label>
                        <input type="text" className="new-org-input" id="orgName" placeholder="Prefijo del inventario" />
                        <label className="orgName">Ubicación</label>
                        <input type="text" className="new-org-input" id="orgName" placeholder="Ubicación del inventario" />
