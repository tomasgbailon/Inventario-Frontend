...
export default function HandleEditors(){
    ...
    const getEditors = async (token, currentTry) => {
        await axios.get(import.meta.env.VITE_API_ADDRESS+'/editpermission/inv/'+organizationId+'/'+inventoryId, {
            headers: {
                Authorization: `Bearer ${token}`,
                Identity: authId,
            },
    ...
    const removePermission = async (token, receptorId, currentTry) => {
        await axios.put(import.meta.env.VITE_API_ADDRESS+'/editpermission/inv/'+organizationId+'/'+inventoryId+'/'+receptorId, {
            status: 'inactive',
        }, {
            headers: {
                Authorization: `Bearer ${token}`,
