...
export default function HandleProyectViewers(){
    ...
    const getEditors = async (token, currentTry) => {
        await axios.get(import.meta.env.VITE_API_ADDRESS+'/viewpermission/proy/'+organizationId+'/'+proyectId, {
            headers: {
                Authorization: `Bearer ${token}`,
                Identity: authId,
            },
    ...
    const removePermission = async (token, receptorId, currentTry) => {
        await axios.put(import.meta.env.VITE_API_ADDRESS+'/viewpermission/proy/'+organizationId+'/'+proyectId+'/'+receptorId, {
            status: 'inactive',
        }, {
            headers: {
                Authorization: `Bearer ${token}`,
