...
export default function DeleteInv(){
    ...
    const handleSubmit = async () => {
        ...
        await axios.delete(import.meta.env.VITE_API_ADDRESS+'/inventories/'+organizationId+'/'+inventoryId, {
            headers: {
            ...
            {((userId !== 0 || isAuthenticated) && (accessLevel === 'admin' || accessLevel === 'owner') ) ? <div className="new-org">
                <NavBar selection={1} />
                    <div className='new-org-content'>
                        ...
                        <div id='small-font'>IMPORTANTE: Esta acción eliminará todas las categorías y productos contenidos en {orgName}</div>
                        <div className='new-org-form'>
                            <label className='orgName' >Escribe el nombre del inventario para confirmar</label>
