...
export default function QuitProy(){
    const { type, organizationId, proyectId } = useParams();
    ...
    const handleSubmit = async () => {
        await axios.put(import.meta.env.VITE_API_ADDRESS+'/'+type+'permission/proy/'+organizationId+'/'+proyectId+'/'+userId, {
            status: 'inactive',
        }, {
            headers: {
