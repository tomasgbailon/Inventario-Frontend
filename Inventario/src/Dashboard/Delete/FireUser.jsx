...
export default function FireUser(){
    ...
    const handleSubmit = async () => {
        ...
        await axios.delete(import.meta.env.VITE_API_ADDRESS+'/organizations/fire/'+organizationId+'/'+targetUserId, {
            headers: {
            ...
            {((userId !== 0 || isAuthenticated) && (accessLevel === 'admin' || accessLevel === 'owner') )? <div className="new-org">
                <NavBar selection={1} />
                    <div className='new-org-content'>
                        <h1>¿Remover todos los permisos a {orgName}?</h1>
                        <div className='new-org-form'>
                            <label className='orgName' >Escribe el nombre del usuario para confirmar</label>
