...
export default function DeleteSubProy(){
    ...
    const handleSubmit = async () => {
        ...
        await axios.delete(import.meta.env.VITE_API_ADDRESS+'/subproyects/'+proyectId+'/'+subproyectId, {
            headers: {
            ...
            {((userId !== 0 || isAuthenticated) && (accessLevel === 'admin' || accessLevel === 'owner') ) ? <div className="new-org">
                <NavBar selection={1} />
                    <div className='new-org-content'>
                        ...
                        <div id='small-font'>IMPORTANTE: Esta acción eliminará todos los productos contenidos en {orgName}</div>
                        <div className='new-org-form'>
                            <label className='orgName' >Escribe el nombre del subproyecto para confirmar</label>
                            ...
                            <button type='submit' className='submit-button' onClick={
                                (e) => {
                                    e.preventDefault();
                                    navigate('/subproy/'+organizationId+'/'+proyectId+'/'+subproyectId);
                                }
                            }>Cancelar</button>
                        </div>
                    </div>
